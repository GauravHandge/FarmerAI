...
export function PaddiAgriAiDrawer({ isOpen, onClose }: PaddiAgriAiDrawerProps) {
  ...
  const handleShareWhatsApp = (text: string) => {
    ...
    const shareText = `🌾 *KisanMitra AI Advisory Report*\n\n${cleanText.slice(0, 1000)}\n\n📲 *Shared via KisanMitra AI Platform*`
  ...
  const handleShareEmail = (text: string) => {
    const cleanText = text.replace(/[*_#`]/g, "").trim()
    const subject = encodeURIComponent("KisanMitra AI Advisory Report")
    const body = encodeURIComponent(`🌾 KisanMitra AI Advisory Report:\n\n${cleanText}\n\nGenerated by KisanMitra AI Platform`)
                        ...
                        <div className="text-xs text-slate-800 leading-relaxed space-y-2 pt-0.5 flex-1 min-w-0 overflow-hidden">
                          ...
                          <div className="flex items-center gap-2 pt-2 border-t border-slate-100 mt-2">
                            <button
                              ...
                              className="flex items-center gap-1.5 text-[11px] font-semibold text-emerald-600 bg-emerald-50 hover:bg-emerald-100 px-2.5 py-1 rounded-full transition-all cursor-pointer shadow-2xs"
                            ...
                            <button
                              ...
                              className="flex items-center gap-1 text-[11px] text-slate-500 hover:text-slate-700 bg-slate-100 hover:bg-slate-200 px-2.5 py-1 rounded-full transition-all cursor-pointer"
                              title="Copy Advisory"
                            >
                            ...
                            <button
                              onClick={() => handleShareEmail(m.content)}
                              className="flex items-center gap-1 text-[11px] text-slate-500 hover:text-slate-700 bg-slate-100 hover:bg-slate-200 px-2.5 py-1 rounded-full transition-all cursor-pointer"
                              title="Email Report"
                            >
